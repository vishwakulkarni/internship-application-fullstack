...
class AttributeRewriter {
  ...
  element(element) {
    ...
    if (element.tagName == 'p' && element.getAttribute('id') == 'description') {
      if (this.attributeName == 'variant1') {
        element.setInnerContent("Lets go to my LinkedIn profile")
      } else {
    ...
    if (element.tagName == 'a' && element.getAttribute('id') == 'url') {
      if (this.attributeName == 'variant1') {
        ...
        element.setAttribute('href', "https://www.linkedin.com/in/vishwakulkarni/")
      } else {
        element.setInnerContent("github")
        element.setAttribute('href', "https://github.com/vishwakulkarni/")
      }
    }
